...
public class LouieApplication implements CommandLineRunner {

    public static void main(String[] args) {
//        SpringApplication.run(LouieApplication.class, args);
        ApplicationContext context = SpringApplication.run(LouieApplication.class, args);
